          ...
          <Form onSubmit={handleSubmit}>
            <Form.Group className="mb-3" controlId="formName">
              ...
              <Form.Control
                ...
                className={`form-control ${
                  user && (validName ? "is-valid" : "is-invalid")
                }`}
                ref={inputRef}
                onChange={(e) => {
            ...
            <Form.Group className="mb-3" controlId="formEmail">
              ...
              <Form.Control
                ...
                placeholder="Email"
                className={`form-control ${
                  mail && (validMail ? "is-valid" : "is-invalid")
                }`}
            ...
            <Form.Group className="mb-3" controlId="formPassword">
              ...
              <Form.Control
                ...
                className={`form-control ${
                  pwd && (validpwd ? "is-valid" : "is-invalid")
                }`}
            ...
            <Form.Group className="mb-3" controlId="formConfirmPassword">
              ...
              <Form.Control
                ...
                className={`form-control ${
                  matchpwd && (validmatchpwd ? "is-valid" : "is-invalid")
                }`}
            ...
            <p className="mt-2">
              ...
              <Link className="ms-2 text-decoration-none text-info" to="/login">
                login
              </Link>
            </p>

            <AddBtn type="submit" className="ms-auto d-block">
              Register
            </AddBtn>
          </Form>
        </Card>
